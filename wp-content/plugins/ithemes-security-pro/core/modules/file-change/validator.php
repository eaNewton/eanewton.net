...
class ITSEC_File_Change_Validator extends ITSEC_Validator {
	...
	protected function sanitize_settings() {
		...
		$this->set_previous_if_empty( array( 'show_warning', 'expected_hashes', 'last_scan', 'latest_changes' ) );
		$this->preserve_setting_if_exists( array( 'email', 'split', 'last_run', 'last_chunk', 'method' ) );
		$this->vars_to_skip_validate_matching_fields = array( 'email', 'split', 'last_run', 'last_chunk', 'method' );
		...
		$this->sanitize_setting( 'array', 'latest_changes', __( 'Latest Changes', 'it-l10n-ithemes-security-pro' ) );
