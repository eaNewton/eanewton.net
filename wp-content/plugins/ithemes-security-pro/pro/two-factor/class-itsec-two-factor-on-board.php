...
class ITSEC_Two_Factor_On_Board {
	...
	public function show_to_user( $user, $requested ) {
		...
		$time_elapsed = ITSEC_Core::get_current_time_gmt() - get_user_meta( $user->ID, self::LAST_PROMPT_META_KEY, true );
	...
	public function render( $user ) {
		...
		wp_enqueue_script( 'itsec-2fa-on-board', plugin_dir_url( __FILE__ ) . 'js/on-board.js', array( 'jquery', 'wp-backbone', 'underscore', 'wp-a11y' ) );
